...
def test_alpaca():
    ...
    try:
        ...
        logger.info(f"  Alpaca Key: {'[SET]' if alpaca_key else 'NONE'}")
...
def test_fmp():
    ...
    try:
        ...
        logger.info(f"  FMP Key: {'[SET]' if fmp_key else 'NONE'}")
...
def massive_quote():
    ...
    try:
        ...
        logger.info(f"Using Massive provider key: {'[SET]' if massive_key else 'NONE'}")
