...
class Memecoin(Base):
    ...
    # Relationships
    positions = relationship('PortfolioPosition', primaryjoin='Memecoin.symbol == foreign(PortfolioPosition.symbol)', foreign_keys='[PortfolioPosition.symbol]', backref='memecoin')
