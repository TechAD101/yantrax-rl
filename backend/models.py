...
class Memecoin(Base):
    ...
    # Relationships
    positions = relationship('PortfolioPosition', primaryjoin='Memecoin.symbol==PortfolioPosition.symbol', foreign_keys='PortfolioPosition.symbol', backref='memecoin', viewonly=True)
