...
class Memecoin(Base):
    ...
    # Relationships
    positions = relationship('PortfolioPosition', backref='memecoin', primaryjoin='foreign(Memecoin.symbol) == PortfolioPosition.symbol', foreign_keys='PortfolioPosition.symbol')
