    ...
    <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700/30 p-6 hover:border-gray-600/50 transition-all duration-300">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center py-2">
          ...
          <div className="text-right">
            <span className={`font-mono text-xl font-bold ${marketData?.changePercent >= 0 ? 'text-green-300' : 'text-red-300'
              }`}>
        ...
        <div className="flex justify-between items-center py-2">
          ...
          <div className="text-right">
            <span className={`font-mono font-bold ${marketData?.changePercent >= 0 ? 'text-green-300' : 'text-red-300'
              }`}>
              {marketData?.change || 'Loading...'}
            </span>
            <div className={`text-xs ${marketData?.changePercent >= 0 ? 'text-green-400' : 'text-red-400'
              }`}>
        ...
        <div className="flex justify-between items-center py-2 pt-4 border-t border-gray-700/30">
          ...
          <div className="text-right flex items-center justify-end space-x-2">
            {marketData?.source && (
              <span className="text-[10px] bg-green-500/10 text-green-400 px-1.5 py-0.5 rounded border border-green-500/20">VERIFIED</span>
            )}
      ...
      <div className="mt-4 p-3 bg-gray-900/50 rounded-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className={`w-3 h-3 rounded-full ${marketData?.changePercent >= 0 ? 'bg-green-500' : 'bg-red-500'
              } animate-pulse`}></div>
